...
import PaginationSelector from "@/components/PeginationSelector";
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
            ...
            <div id="main-content" className="flex flex-col gap-5">
                <SearchBar searchQuery={SearchState.searchQuery} onSubmit={setSearchQuery} placeHolder="search bt cusine or Restaurant Name" onReset={resetSearch} />
